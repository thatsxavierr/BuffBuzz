...
export default function SignupPage() {
  ...
  const validateForm = () => {
    const newErrors = {
      ...
      password: formData.password.length < 8 || /\s/.test(formData.password),
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            ...
            <input
              ...
              disabled={loading}
            />
            {errors.password && <span className="error">Password must be at least 8 characters and cannot contain spaces</span>}
          </div>
